...
function api_promocao_put($request){
    ...
    if($user_id > 0){
        ...
        update_post_meta($imagem_id, 'banner', $banner);
        update_post_meta($imagem_id, 'conteudo', $conteudo);
        update_post_meta($imagem_id, 'data_ini', $data_ini);
        update_post_meta($imagem_id, 'data_fim', $data_fim);
