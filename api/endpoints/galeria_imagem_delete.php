...
//API IMAGENS DELETE
function api_galeria_imagems_delete($request){
...
function registrar_api_galeria_imagems_delete(){

    register_rest_route('api', '/galeria-imagem/(?P<slug>[-\w]+)', array(
        array(
            'methods' => WP_REST_Server::DELETABLE,
            'callback' => 'api_galeria_imagems_delete',
        ),
    ));
}

add_action('rest_api_init','registrar_api_galeria_imagems_delete');
